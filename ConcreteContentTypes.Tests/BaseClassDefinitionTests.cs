...
{
	[TestClass]
	public class BaseClassDefinitionTests
	{
		[TestMethod]
		public void UmbracoBaseClassDefinitionTests_Construct()
		{
			...
			var sut = new BaseClassDefinition(name, nameSpace, PublishedItemType.Content);
		...
		public void UmbracoBaseClassDefintionTests_GetUsingNamespaces_OneClassAttributeOnePropertyAttribute()
		{
			...
			var propertyDefinition = new BaseClassPropertyDefinition(BaseClassProperty.Name);
