...
{
	[TestClass]
	public class UmbracoMediaTypesSourceModelMapperTests
	{
		[TestMethod]
		public void UmbracoMediaTypesSourceModelMapper_Construct()
		{
			...
			var sut = new UmbracoMediaTypesSourceModelMapper(settings, eventsMock.Object, mediaTypes);
		...
		public void UmbracoMediaTypesSourceModelMapper_GetBaseClassDefinition()
		{
			...
			eventsMock.Verify(x => x.RaiseMediaBaseClassGenerating(It.IsAny<UmbracoBaseClassDefinition>()),
				Times.Once,
			...
			Assert.AreEqual(Enum.GetValues(typeof(UmbracoBaseClassProperty)).Length, baseClassDefinition.Properties.Count());
		}
		...
		public void UmbracoMediaTypesSourceModelMapper_Map_SingleContentType_NoProperties()
		{
			...
			var sut = new UmbracoMediaTypesSourceModelMapper(settings, eventsMock.Object, new List<IMediaType>() { testContentType.Object });
		...
		public void UmbracoMediaTypesSourceModelMapper_GetModelClassDefinitions_TwoContentTypes_NoProperties()
		{
			...
			var sut = new UmbracoMediaTypesSourceModelMapper(settings, eventsMock.Object, new List<IMediaType>() { testMediaType.Object, testMediaType2.Object });
			...
			eventsMock.Verify(x => x.RaiseMediaModelClassGenerating(It.IsAny<UmbracoModelClassDefinition>()),
