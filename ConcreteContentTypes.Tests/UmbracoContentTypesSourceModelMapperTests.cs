...
{
	[TestClass]
	public class UmbracoContentTypesSourceModelMapperTests
	{
		[TestMethod]
		public void UmbracoContentTypesSourceModelMapper_Construct()
		{
			...
			var sut = new UmbracoContentTypeSourceModelMapper(settings, eventsMock.Object, contentTypes);
		...
		public void UmbracoContentTypesSourceModelMapper_GetBaseClassDefinition()
		{
			...
			eventsMock.Verify(x => x.RaiseContentBaseClassGenerating(It.IsAny<UmbracoBaseClassDefinition>()),
				Times.Once,
		...
		public void UmbracoContentTypesSourceModelMapper_GetModelClassDefinitions_SingleContentType_NoProperties()
		{
			...
			var sut = new UmbracoContentTypeSourceModelMapper(settings, eventsMock.Object, new List<IContentType>() { testContentType.Object });
		...
		public void UmbracoContentTypesSourceModelMapper_GetModelClassDefinitions_TwoContentTypes_NoProperties()
		{
			...
			var sut = new UmbracoContentTypeSourceModelMapper(settings, eventsMock.Object, new List<IContentType>() { testContentType.Object, testContentType2.Object });
