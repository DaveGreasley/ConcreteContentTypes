...
{
	[TestClass]
	public class UmbracoModelClassDefinitionTests
	{
		[TestMethod]
		public void UmbracoModelClassDefinition_Construct()
		{
			...
			var sut = new UmbracoModelClassDefinition(name, nameSpace);
		...
		public void UmbracoBaseClassDefintionTests_GetUsingNamespaces_OneClassAttributeOnePropertyAttribute()
		{
			...
			var propertyDefinition = new UmbracoModelClassPropertyDefinition("Test Property", "TestProperty");
