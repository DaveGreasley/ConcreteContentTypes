...
namespace ConcreteContentTypes.Tests
{
	...
	public class BaseClassTemplateTests
	{
		...
		//	Assert.AreSame(attributeTemplateMock.Object, sut.AttributeTemplateFactory, "AttributeTemplate not set properly");
		...
		//	var sut = new BaseClassTemplate(attributeTemplateMock.Object);
		//	string generatedCode = sut.GenerateCode(baseClassDefinition);
