...
{
	[ConfigurationCollection(typeof(PropertyEditorConfiguration), AddItemName="Type")]
	public class SupportedTypesConfigurationCollection : ConfigurationElementCollection, IEnumerable<PropertyEditorConfiguration>
	{
