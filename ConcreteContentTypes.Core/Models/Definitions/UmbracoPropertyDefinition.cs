...
{
	public class UmbracoPropertyDefinition : PropertyDefinition
	{
		...
		public UmbracoPropertyDefinition(PropertyType propertyType)
		...
		public UmbracoPropertyDefinition(
			...
			string description,
			bool required)
			: base("", "", new List<AttributeDefinition>())
		{
